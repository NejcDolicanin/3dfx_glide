...
# this also turns on asm (3dnow!) optimization
HAL_CSIM=
#
#FX_GLIDE_NO_FIFO=0
#FX_GLIDE_DEBUG_FIFO=0
#
...
#
# use C setup. this switches assembler options.
...
#
!if "$(FX_GLIDE3)"=="1"
LCDEFS = $(LCDEFS) -DGLIDE3_VERTEX_LAYOUT=1 -DGLIDE3_SCALER=1 -DGLIDE_CHECK_TRILINEAR=1
!endif
#
