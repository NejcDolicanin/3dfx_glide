...
**
** $Header: /cvsroot/glide/glide2x/h3/glide/src/disst.c,v 1.1.1.1 1999/12/07 21:49:26 joseph Exp $
** $Log: disst.c,v $
** Revision 1.1.1.1  1999/12/07 21:49:26  joseph
** Initial checkin into SourceForge.
**
** 4     9/02/02 KoolSmoky fixed hang on res changes
** 
** 3     3/17/99 6:16p Dow
