...
;;
;; $Header: f:\\cvsroot/Glide3x/h5/glide3/src/xtexdl.asm,v 1.5 2002/04/13 16:53:27 KoolSmoky Exp $
;; $Revision: 1.5 $
;; $Log: xtexdl.asm,v $
...
ifdef USE_PACKET_FIFO
    ...
    call      __FifoMakeRoom@12         ; make fifo room
...
ifdef USE_PACKET_FIFO
    ...
    call      __FifoMakeRoom@12         ; make fifo room (if fifoPtr QWORD aligned before
