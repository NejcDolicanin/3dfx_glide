...
**
** $Header: f:\\cvsroot/Glide3x/h5/glide3/src/disst.c,v 1.6 2002/04/28 23:06:54 KoolSmoky Exp $
** $Log:
...
GR_DIENTRY(grSstSelect, void, ( int which ))
{
  ...
  if(oldwhich != which) _GlideRoot.initialized = FXFALSE;
