...
**
** 
** $Header: f:\\cvsroot/Glide3x/h5/glide3/src/gglide.c,v 1.8 2002/05/04 02:07:42 KoolSmoky Exp $
** $Log:
...
#define FN_NAME "grTBufferWriteMaskExt"
  ...
  FxU32 chipIndex, chipEnList, tBufferSampleOffsetIndex, chipaamode[4];
