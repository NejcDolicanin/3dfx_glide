...
**
** $Header: f:\\cvsroot/Glide3x/h5/glide3/src/ditex.c,v 1.7 2002/05/04 02:07:42 KoolSmoky Exp $
** $Log
 ...
 */
const FxU32 _grMipMapHostSizeDXT[4/*7*/][GR_LOD_LOG2_2048+1] =
{
  {                  /* 8:1 aspect ratio */
         16,         /*  0 :    4x4    */
         16,         /*  1 :    4x4    */
...
static const FxU32 _grMipMapSizeDXT[4/*7*/][16] = {
  {                  /* 8:1 aspect ratio */
    0x000010,        /*   0 :    4x4    */
    0x000010,        /*   1 :    4x4    */
    0x000010,        /*   2 :    4x4    */
 ...
 * textures, where 4x4 is the minimum size. DXT2,3,4,5
 */
const FxI32 _grMipMapOffsetDXT[4/*7*/][16] = {
  {                  /* 8:1 aspect ratio */
...
#if 0
  {                  /* 1:2 aspect ratio */
     43728, /* Sum(128x256,64x128,32x64,16x32,8x16,4x8,4x4,4x4,4x4)   */
     43712, /* Sum(128x256,64x128,32x64,16x32,8x16,4x8,4x4,4x4)       */
     43696, /* Sum(128x256,64x128,32x64,16x32,8x16,4x8,4x4)           */
     43680, /* Sum(128x256,64x128,32x64,16x32,8x16,4x8)               */
     43648, /* Sum(128x256,64x128,32x64,16x32,8x16)                   */
     43520, /* Sum(128x256,64x128,32x64,16x32)                        */
     43008, /* Sum(128x256,64x128,32x64)                              */
     40960, /* Sum(128x256,64x128)                                    */
  ...
  {                  /* 1:4 aspect ratio */
     21904, /* Sum(64x256,32x128,16x64,8x32,4x16,4x8,4x4,4x4,4x4)     */
     21888, /* Sum(64x256,32x128,16x64,8x32,4x16,4x8,4x4,4x4)         */
     21872, /* Sum(64x256,32x128,16x64,8x32,4x16,4x8,4x4)             */
     21856, /* Sum(64x256,32x128,16x64,8x32,4x16,4x8)                 */
     21824, /* Sum(64x256,32x128,16x64,8x32,4x16)                     */
     21760, /* Sum(64x256,32x128,16x64,8x32)                          */
     21504, /* Sum(64x256,32x128,16x64)                               */
     20480, /* Sum(64x256,32x128)                                     */
     16384, /* Sum(64x256)                                            */
  ...
  {                  /* 1:8 aspect ratio */
     11024, /* Sum(32x256,16x128,8x64,4x32,4x16,4x8,4x4,4x4,4x4)      */
     11008, /* Sum(32x256,16x128,8x64,4x32,4x16,4x8,4x4,4x4)          */
     10992, /* Sum(32x256,16x128,8x64,4x32,4x16,4x8,4x4)              */
     10976, /* Sum(32x256,16x128,8x64,4x32,4x16,4x8)                  */
     10944, /* Sum(32x256,16x128,8x64,4x32,4x16)                      */
     10880, /* Sum(32x256,16x128,8x64,4x32)                           */
     10752, /* Sum(32x256,16x128,8x64)                                */
     10240, /* Sum(32x256,16x128)                                     */
      8192, /* Sum(32x256)                                            */
         0, /* Base address (beginning of 64x512 level)               */
 ...
 * textures, where 4x4 is the minimum size. DXT2,3,4,5
 */
const FxI32 _grMipMapOffset_TsplitDXT[4/*7*/][16] = {
  {                  /* 8:1 aspect ratio */
...
#if 0
  {                  /* 1:2 aspect ratio */
     34976, /* Sum(128x256,32x64,8x16,4x4,4x4)                        */
      8752, /* Sum(64x128,16x32,4x8,4x4)                              */
     34960, /* Sum(128x256,32x64,8x16,4x4)                            */
      8736, /* Sum(64x128,16x32,4x8)                                  */
     34944, /* Sum(128x256,32x64,8x16)                                */
      8704, /* Sum(64x128,16x32)                                      */
     34816, /* Sum(128x256,32x64)                                     */
      8192, /* Sum(64x128)                                            */
  ...
  {                  /* 1:4 aspect ratio */
     17504, /* Sum(64x256,16x64,4x16,4x4,4x4)                         */
      4400, /* Sum(32x128,8x32,4x8,4x4)                               */
     17488, /* Sum(64x256,16x64,4x16,4x4)                             */
      4384, /* Sum(32x128,8x32,4x8)                                   */
     17472, /* Sum(64x256,16x64,4x16)                                 */
      4352, /* Sum(32x128,8x32)                                       */
     17408, /* Sum(64x256,16x64)                                      */
      4096, /* Sum(32x128)                                            */
     16384, /* Sum(64x256)                                            */
  ...
  {                  /* 1:8 aspect ratio */
      8800, /* Sum(32x256,8x64,4x16,4x4,4x4)                          */
      2224, /* Sum(16x128,4x32,4x8,4x4)                               */
      8784, /* Sum(32x256,8x64,4x16,4x4)                              */
      2208, /* Sum(16x128,4x32,4x8)                                   */
      8768, /* Sum(32x256,8x64,4x16)                                  */
      2176, /* Sum(16x128,4x32)                                       */
      8704, /* Sum(32x256,8x64)                                       */
      2048, /* Sum(16x128)                                            */
      8192, /* Sum(32x256)                                            */
         0, /* Base address (beginning of 16x128 level)               */
